...
import reservation_bg from '../images/reservation_bg.jpg';

function Reservation() {
  return (
    <>
        <section className="reservation mt_100 xs_mt_70">
        <div className="container">
            <div className="reservation_bg" style={{backgroundImage: "url(" + reservation_bg + ")"}}>
                <div className="row">
